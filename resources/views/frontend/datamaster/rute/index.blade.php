        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="relative overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400" id="myTable">
                    ...
                    <tbody>
                        @foreach ($rute->sortBy('id') as $rutes)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="py-4 px-6 text-sm font-medium text-right whitespace-nowrap">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('datamaster.rute.edit', $rutes->id) }}"
                                        ...
                                        <form class="inline-flex items-center px-4 py-2 bg-red-500 hover:bg-red-700 rounded-lg text-white" method="POST" action="{{ route('datamaster.rute.destroy', $rutes->id) }}" onsubmit="return confirm('Are You Sure?')">
                                            @csrf
                                            @method('DELETE')
