<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="px-2 py-8 mx-auto max-w-2xl lg:py-16 bg-white dark:bg-gray-700 m-12 rounded-lg md:p-16 sm:p-8">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Catat Pemasukan</h2>
            <form action="{{ route('pencatatan.pemasukan.store') }}" method="POST">
                @csrf
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        @error('nominal_pemasukan')
                            <div class="text-sm text-red-400">{{ $message }}</div>
                        @enderror
                        <small id="formatted_nominal" class="text-gray-500 dark:text-gray-300">Format: </small>
                    </div>
                    <div class="w-full">
