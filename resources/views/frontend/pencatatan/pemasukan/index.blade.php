                        ...
                        @foreach ($pemasukan as $pemasukans)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td scope="row"
                                    ...
                                    {{ $pemasukans->Nomor_Referensi }}
                                </td>
                                <td scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ $pemasukans->Nama_Kontak }}
                                </td>
                                <td scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    @if ($pemasukans->saldo)
                                ...
                                <td scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ $pemasukans->DariAkun->Nama_Akun }} - {{ $pemasukans->KeAkun->Nama_Akun }}
                                </td>
                                <td scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                ...
                                <td class="py-4 px-6 text-sm font-medium text-right whitespace-nowrap">
                                    <div class="flex space-x-2">
                                        <a href="{{ route('pencatatan.pemasukan.edit', $pemasukans->id) }}"
                                            ...
                                            title="Edit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                                class="w-5 h-5 fill-white">
                                                <path
                                                    d="M362.7 19.3L314.3 67.7 444.3 197.7l48.4-48.4c25-25 25-65.5 0-90.5L453.3 19.3c-25-25-65.5-25-90.5 0zm-71 71L58.6 323.5c-10.4 10.4-18 23.3-22.2 37.4L1 481.2C-1.5 489.7 .8 498.8 7 505s15.3 8.5 23.7 6.1l120.3-35.4c14.1-4.2 27-11.8 37.4-22.2L421.7 220.3 291.7 90.3z" />
                                            </svg></a>
                                        <a href="{{ route('pencatatan.pemasukan.journalVoucher', $pemasukans->id) }}"
                                            target="_blank"
                                        ...
                                        <form method="POST" title="Trash"
                                            action="{{ route('pencatatan.pemasukan.destroy', $pemasukans->id) }}"
