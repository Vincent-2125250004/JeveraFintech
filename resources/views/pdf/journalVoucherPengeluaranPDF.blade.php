...
<body>
    ...
    <table class="tableInvis">
        <tbody>
            <tr>
                <td class="kolom1">Kontak : {{ $pengeluaran->Nama_Kontak }}</td>
                <td class="kolom2">Tanggal : {{ $pengeluaran->Tanggal_Pengeluaran }}</td>
            </tr>
            <tr>
                <td class="kolom1" style="margin-top: 5px">Nomor Referensi : {{ $pengeluaran->Nomor_Referensi }}</td>
            </tr>
            <tr>
                <td colspan="2" class="kolom1">Keterangan : {{ $pengeluaran->Deskripsi }}</td>
            </tr>
