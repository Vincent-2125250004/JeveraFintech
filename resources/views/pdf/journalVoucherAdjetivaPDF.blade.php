...
<body>
    ...
    <table class="tableInvis">
        <tbody>
            <tr>
                {{-- <td class="kolom1">Kontak : {{ $adjetiva->Nama_Kontak }}</td> --}}
                <td class="kolom1">Tanggal : {{ $adjetiva->Tanggal_Adjetiva }}</td>
            </tr>
            <tr>
                <td class="kolom1">Nomor Referensi : {{ $adjetiva->Nomor_Referensi }}</td>
            </tr>
            <tr>
                <td colspan="2" class="kolom1">Keterangan : {{ $adjetiva->Deskripsi }}</td>
            </tr>
        </tbody>
    </table>
